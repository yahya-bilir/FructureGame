...
{
    [CustomPropertyDrawer(typeof(FPD_SingleLineTwoPropsAttribute))]
    public class FPD_SingleLineTwoPropsDrawer : PropertyDrawer
    {
        ...
        {
            FPD_SingleLineTwoPropsAttribute att = (FPD_SingleLineTwoPropsAttribute)base.attribute;
