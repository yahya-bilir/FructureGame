...
public class ElectricAttacking : IState
{
    ...
    public ElectricAttacking(CharacterCombatManager combatManager, RangedWeapon rangedWeapon, Transform weaponTransform,
    ...
    public void OnEnter()
    {
        _aiText.text = "Attacking (ELECTRIC)";
