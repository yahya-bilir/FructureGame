...
//		print(projectileParticleName);
	...
	public bool overButton()		// This function will return either true or false
	{
		...
		if(button1.Contains(new Vector2(UnityEngine.Input.mousePosition.x, Screen.height - UnityEngine.Input.mousePosition.y)) ||
		   button2.Contains(new Vector2(UnityEngine.Input.mousePosition.x, Screen.height - UnityEngine.Input.mousePosition.y)))
		{
			return true;
		}
		else
