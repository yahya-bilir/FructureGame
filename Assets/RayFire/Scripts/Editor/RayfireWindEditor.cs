...
namespace RayFireEditor
{
    ...
    public class RayfireWindEditor : Editor
    {
        ...
        void GUI_Gizmo()
        {
            RFUI.CaptionBox (TextWnd.gui_cap_giz);
            RFUI.PropertyField (sp_giz_show, TextWnd.gui_giz_show);
            RFUI.PropertyField (sp_giz_size, TextWnd.gui_giz_size);
        }

        void GUI_Noise()
        {
            RFUI.CaptionBox (TextWnd.gui_cap_nse);
            RFUI.PropertyField (sp_nse_show, TextWnd.gui_nse_show);
            RFUI.Slider (sp_nse_global, global_min, global_max, TextWnd.gui_nse_global);
            RFUI.Slider (sp_nse_length, length_min, length_max, TextWnd.gui_nse_length);
            RFUI.Slider (sp_nse_width,  width_min,  width_max,  TextWnd.gui_nse_width);
            RFUI.Slider (sp_nse_speed,  speed_min,  speed_max,  TextWnd.gui_nse_speed);
        }

        void GUI_Strength()
        {
            RFUI.CaptionBox (TextWnd.gui_cap_str);
            RFUI.Slider (sp_str_min, strength_min, strength_max, TextWnd.gui_str_min);
            RFUI.Slider (sp_str_max, strength_min, strength_max, TextWnd.gui_str_max);
            RFUI.Slider (sp_str_tor, torque_min,   torque_max,   TextWnd.gui_str_tor);
            RFUI.PropertyField (sp_str_frc, TextWnd.gui_str_frc);
        }
        
        void GUI_Direction()
        {
            RFUI.CaptionBox (TextWnd.gui_cap_dir);
            RFUI.Slider (sp_dir_div, divergency_min, divergency_max, TextWnd.gui_dir_div);
            RFUI.Slider (sp_dir_tur, turbulence_min, turbulence_max, TextWnd.gui_dir_tur);
        }

        void GUI_Preview()
        {
            RFUI.CaptionBox (TextWnd.gui_cap_prev);
            RFUI.Slider (sp_prv_dens, density_min, density_max, TextWnd.gui_prv_dens);
            RFUI.Slider (sp_prv_size, size_min,    size_max, TextWnd.gui_prv_size);
        }
        
        void GUI_Filters()
        {
            RFUI.CaptionBox (TextWnd.gui_cap_flt);
            RFUI.TagField (sp_tag, TextWnd.gui_tag);
            RFUI.MaskField (sp_mask, TextWnd.gui_lay);
        }
