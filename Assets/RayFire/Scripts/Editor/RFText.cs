...
namespace RayFireEditor
{
    ...
    public static class TextKeys
    {
        ...
        public const string rig_fld_res = "rf_re"; public const string rig_fld_prp = "rf_rv"; 
    ...
    public static class TextMsh
    {
        ...
        public static readonly GUIContent gui_cap_frg     = new GUIContent ("  Fragments",        "");
        public static readonly GUIContent gui_msh_en      = new GUIContent ("Engine: ",           "");
        ...
        public static readonly GUIContent gui_msh_adv_slc = new GUIContent ("Slice Type",         "Detach all disconnected triangles into separate fragments.");
        public static readonly GUIContent gui_msh_adv_cmb = new GUIContent ("Combine",            "Combine fragments meshes from separated elements per Voronoi point cell.");
        public static readonly GUIContent gui_msh_adv_cap = new GUIContent ("Input Cap",          "Cap open edges before fragment mesh.");
        ...
        public static readonly GUIContent gui_msh_adv_col = new GUIContent ("Collider",           TextSht.tlp_slice);
    ...
    public static class TextRig
    {
        ...
        public const string hlp_depth  = "High Depth may increase amount of generated fragments exponentially.";
    ...
    public static class TextSht
    {
        ...
        public const string tlp_slice  = " Hybrid: Meshes with open edges will be cut over their surface and meshes with closed edges will be sliced to fragments with inner surface. Should be used for tree like objects. \n" +
        ...
        public static readonly GUIContent gui_mat_uvMin       = new GUIContent ("    Min",                 "");
