...
namespace RayFireEditor
{
    ...
    public class RayfireDebrisEditor : Editor
    {
        ...
        void GUI_Emit()
        {
            RFUI.CaptionBox (TextDbr.gui_cap_event);
            RFUI.PropertyField (sp_main_dml, TextDbr.gui_main_dml);
            RFUI.PropertyField (sp_main_act, TextDbr.gui_main_act);
            RFUI.PropertyField (sp_main_imp, TextDbr.gui_main_imp);
            if (sp_main_dml.boolValue == false && sp_main_act.boolValue == false && sp_main_imp.boolValue == false)
                RFUI.HelpBox (TextDbr.hlp_select, MessageType.Warning, true);
        }
        ...
        void GUI_Main()
        {
            RFUI.CaptionBox (TextDbr.gui_cap_debris);
            RFUI.PropertyField (sp_main_ref, TextDbr.gui_main_ref);
            RFUI.PropertyField (sp_main_mat, TextDbr.gui_main_mat);
        }
        ...
        void GUI_Properties()
        {
            RFUI.CaptionBox (TextDbr.gui_cap_props);
            GUI_Pool();
            GUI_Emission();
            GUI_Dynamic();
            GUI_Noise();
        ...
        void GUI_Pool()
        {
            RFUI.Foldout (ref fld_pol, TextKeys.deb_fld_pol, TextDbr.gui_fld_pol.text);
            if (fld_pol == true)
            {
                EditorGUI.indentLevel++;
                RFUI.IntSlider (sp_pol_id, pl_id_min, pl_id_max, TextDbr.gui_pol_id);
                RFUI.PropertyField (sp_pol_en,  TextDbr.gui_pol_en);
                RFUI.PropertyField (sp_pol_war, TextDbr.gui_pol_war);
                RFUI.IntSlider (sp_pol_cap, pl_cap_min, pl_cap_max, TextDbr.gui_pol_cap);
                RFUI.IntSlider (sp_pol_rat, pl_rat_min, pl_rat_max, TextDbr.gui_pol_rat);
                RFUI.PropertyField (sp_pol_skp, TextDbr.gui_pol_skp);
                RFUI.PropertyField (sp_pol_reu, TextDbr.gui_pol_reu);
                if (debris.pool.reuse == true)
                    RFUI.IntSlider (sp_pol_ovf, pl_ovf_min, pl_ovf_max, TextDbr.gui_pol_ovf);
        ...
        void GUI_Emission()
        {
            RFUI.Foldout (ref fld_emt, TextKeys.deb_fld_emt, TextDbr.gui_fld_emt.text);
            if (fld_emt == true)
            {
                EditorGUI.indentLevel++;
                RFUI.Caption (TextDbr.gui_cap_burst);
                RFUI.PropertyField (sp_ems_tp, TextDbr.gui_ems_tp);
                if (debris.emission.burstType != RFParticles.BurstType.None)
                {
                    RFUI.IntSlider (sp_ems_am,  ems_am_min,  ems_am_max,  TextDbr.gui_ems_am);
                    RFUI.IntSlider (sp_ems_var, ems_var_min, ems_var_max, TextDbr.gui_ems_var);
                }
                RFUI.Caption (TextDbr.gui_cap_dist);
                RFUI.Slider (sp_ems_rate, ems_rate_min, ems_rate_max, TextDbr.gui_ems_rate);
                RFUI.Slider (sp_ems_dur,  ems_dur_min,  ems_dur_max,  TextDbr.gui_ems_dur);
                RFUI.Caption (TextDbr.gui_cap_life);
                RFUI.Slider (sp_ems_life_min, ems_life_min, ems_life_max, TextDbr.gui_ems_life_min);
                RFUI.Slider (sp_ems_life_max, ems_life_min, ems_life_max, TextDbr.gui_ems_life_max);
                RFUI.Caption (TextDbr.gui_cap_size);
                RFUI.Slider (sp_ems_size_min, ems_size_min_min, ems_size_min_max, TextDbr.gui_ems_size_min);
                RFUI.Slider (sp_ems_size_max, ems_size_max_min, ems_size_max_max, TextDbr.gui_ems_size_max);
                RFUI.Caption (TextDbr.gui_cap_mat);
                RFUI.PropertyField (sp_ems_mat, TextDbr.gui_ems_mat);
                EditorGUI.indentLevel--;
            }
        }
        ...
        void GUI_Dynamic()
        {
            RFUI.Foldout (ref fld_dyn, TextKeys.deb_fld_dyn, TextDbr.gui_fld_dyn.text);
            if (fld_dyn == true)
            {
                EditorGUI.indentLevel++;
                RFUI.Caption (TextDbr.gui_cap_speed);
                RFUI.Slider (sp_dyn_speed_min, dyn_speed_min, dyn_speed_max, TextDbr.gui_dyn_speed_min);
                RFUI.Slider (sp_dyn_speed_max, dyn_speed_min, dyn_speed_max, TextDbr.gui_dyn_speed_max);
                RFUI.Caption (TextDbr.gui_cap_vel);
                RFUI.Slider (sp_dyn_vel_min, dyn_vel_min, dyn_vel_max, TextDbr.gui_dyn_vel_min);
                RFUI.Slider (sp_dyn_vel_max, dyn_vel_min, dyn_vel_max, TextDbr.gui_dyn_vel_max);
                RFUI.Caption (TextDbr.gui_cap_grav);
                RFUI.Slider (sp_dyn_grav_min, dyn_grav_min, dyn_grav_max, TextDbr.gui_dyn_grav_min);
                RFUI.Slider (sp_dyn_grav_max, dyn_grav_min, dyn_grav_max, TextDbr.gui_dyn_grav_max);
                RFUI.Caption (TextDbr.gui_cap_rot);
                RFUI.Slider (sp_dyn_rot, dyn_rot_min, dyn_rot_max, TextDbr.gui_dyn_rot);
                EditorGUI.indentLevel--;
            }
        }
        ...
        void GUI_Noise()
        {
            RFUI.Foldout (ref fld_nse, TextKeys.deb_fld_nse, TextDbr.gui_fld_nse.text);
            if (fld_nse == true)
            {
                EditorGUI.indentLevel++;
                RFUI.Caption (TextDbr.gui_cap_main);
                RFUI.PropertyField (sp_nse_en, TextDbr.gui_nse_en);
                if (debris.noise.enabled == true)
                {
                    RFUI.PropertyField (sp_nse_qual, TextDbr.gui_nse_qual);
                    RFUI.Caption (TextDbr.gui_cap_str);
                    RFUI.Slider (sp_nse_str_min, nse_str_min, nse_str_max, TextDbr.gui_nse_str_min);
                    RFUI.Slider (sp_nse_str_max, nse_str_min, nse_str_max, TextDbr.gui_nse_str_max);
                    RFUI.Caption (TextDbr.gui_cap_other);
                    RFUI.Slider (sp_nse_freq,   nse_freq_min,   nse_freq_max,   TextDbr.gui_nse_freq);
                    RFUI.Slider (sp_nse_scroll, nse_scroll_min, nse_scroll_max, TextDbr.gui_nse_scroll);
                    RFUI.PropertyField (sp_nse_damp, TextDbr.gui_nse_damp);
                }
                EditorGUI.indentLevel--;
            }
        }
        ...
        void GUI_Collision()
        {
            RFUI.Foldout (ref fld_col, TextKeys.deb_fld_col, TextDbr.gui_fld_col.text);
            if (fld_col == true)
            {
                EditorGUI.indentLevel++;
                RFUI.Caption (TextDbr.gui_cap_common);
                RFUI.MaskField(sp_col_mask, TextDbr.gui_col_mask);
                RFUI.PropertyField (sp_col_qual, TextDbr.gui_col_qual);
                RFUI.Slider (sp_col_rad, col_rad_min, col_rad_max, TextDbr.gui_col_rad);
                RFUI.Caption (TextDbr.gui_cap_dampen);
                RFUI.PropertyField (sp_col_dmp_tp, TextDbr.gui_col_dmp_tp);
                if (debris.collision.dampenType == RFParticleCollisionDebris.RFParticleCollisionMatType.ByProperties)
                {
                    RFUI.Slider (sp_col_dmp_min, col_dmp_min, col_dmp_max, TextDbr.gui_col_dmp_min);
                    RFUI.Slider (sp_col_dmp_max, col_dmp_min, col_dmp_max, TextDbr.gui_col_dmp_max);
                }
                RFUI.Caption (TextDbr.gui_cap_bounce);
                RFUI.PropertyField (sp_col_bnc_tp, TextDbr.gui_col_bnc_tp);
                if (debris.collision.bounceType == RFParticleCollisionDebris.RFParticleCollisionMatType.ByProperties)
                {
                    RFUI.Slider (sp_col_bnc_min, col_bnc_min, col_bnc_max, TextDbr.gui_col_bnc_min);
                    RFUI.Slider (sp_col_bnc_max, col_bnc_min, col_bnc_max, TextDbr.gui_col_bnc_max);
                }
                EditorGUI.indentLevel--;
            }
        }
        ...
        {
            RFUI.Foldout (ref fld_lim, TextKeys.deb_fld_lim, TextDbr.gui_fld_lim.text);
            if (fld_lim == true)
            {
                EditorGUI.indentLevel++;
                RFUI.Caption (TextDbr.gui_cap_prt);
                RFUI.IntSlider (sp_lim_prt_min, lim_prt_min, lim_prt_max, TextDbr.gui_lim_prt_min);
                RFUI.IntSlider (sp_lim_prt_max, lim_prt_min, lim_prt_max, TextDbr.gui_lim_prt_max);
                RFUI.PropertyField (sp_lim_prt_vis, TextDbr.gui_lim_prt_vis);
                RFUI.Caption (TextDbr.gui_cap_frags);
                RFUI.IntSlider (sp_lim_perc, lim_perc_min, lim_perc_max, TextDbr.gui_lim_perc);
                RFUI.Slider (sp_lim_size, lim_size_min, lim_size_max, TextDbr.gui_lim_size);
                EditorGUI.indentLevel--;
            }
        }
        ...
        void GUI_Rendering()
        {
            RFUI.Foldout (ref fld_rnd, TextKeys.deb_fld_rnd, TextDbr.gui_fld_ren.text);
            if (fld_rnd == true)
            {
                EditorGUI.indentLevel++;
                RFUI.Caption (TextDbr.gui_cap_shad);
                RFUI.PropertyField (sp_ren_cast, TextDbr.gui_ren_cast);
                RFUI.PropertyField (sp_ren_rec, TextDbr.gui_ren_rec);
                RFUI.Caption (TextDbr.gui_cap_other);
                RFUI.PropertyField (sp_ren_prob, TextDbr.gui_ren_prob);
                RFUI.PropertyField (sp_ren_vect, TextDbr.gui_ren_vect);
                RFUI.PropertyField (sp_ren_t,    TextDbr.gui_ren_t);
                if (debris.rendering.t == true)
                    RFUI.TagField (sp_ren_tag, TextDbr.gui_ren_tag);
                RFUI.PropertyField (sp_ren_l, TextDbr.gui_ren_l);
