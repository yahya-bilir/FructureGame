...
namespace RayFireEditor
{
    ...
    public class RayfireCombineEditor : Editor
    {
        ...
        void UI_Source()
        {
            RFUI.CaptionBox (TextCmb.gui_cap_source);
            RFUI.PropertyField (sp_type, TextCmb.gui_type);
        ...
        void UI_Mesh()
        {
            RFUI.Caption (TextCmb.gui_cap_mesh);
            RFUI.PropertyField (sp_meshFilters,     TextCmb.gui_meshFilters);
            RFUI.PropertyField (sp_skinnedMeshes,   TextCmb.gui_skinnedMeshes);
            RFUI.PropertyField (sp_particleSystems, TextCmb.gui_particleSystems);
        }

        void UI_Filters()
        {
            RFUI.CaptionBox (TextCmb.gui_cap_filters);
            RFUI.Slider (sp_sizeThreshold, sizeThreshold_min, sizeThreshold_max, TextCmb.gui_sizeThreshold);
            RFUI.IntSlider (sp_vertexThreshold, vertexThreshold_min, vertexThreshold_max, TextCmb.gui_vertexThreshold);
        }

        void UI_Comb()
        {
            RFUI.CaptionBox (TextCmb.gui_cap_index);
            RFUI.PropertyField (sp_indexFormat, TextCmb.gui_indexFormat);
        }

        void UI_Export()
        {
            RFUI.CaptionBox (TextCmb.gui_cap_export);
