...
namespace RayFireEditor
{
    ...
    public class RayfireSoundEditor : Editor
    {
        ...
        void GUI_Vol()
        {
            RFUI.Caption (TextSnd.gui_cap_vol);
            RFUI.Slider (sp_vol_base, baseVolume_min, baseVolume_max, TextSnd.gui_vol_base);
            RFUI.Slider (sp_vol_size, sizeVolume_min, sizeVolume_max, TextSnd.gui_vol_size);
        }
        ...
        void GUI_Events()
        {
            RFUI.Caption (TextSnd.gui_cap_eve);
            RFUI.PropertyField (sp_eve_ini, TextSnd.gui_eve_ini);
            if (sound.initialization.enable == true)
                GUI_PropsInit();
            RFUI.PropertyField (sp_eve_act, TextSnd.gui_eve_act);
            if (sound.activation.enable == true)
                GUI_PropsAct();
            RFUI.PropertyField (sp_eve_dml, TextSnd.gui_eve_dml);
            if (sound.demolition.enable == true)
                GUI_PropsDml();
            RFUI.PropertyField (sp_eve_col, TextSnd.gui_eve_col);
        ...
        void GUI_PropsInit()
        {
            ...
            RFUI.PropertyField (sp_ini_once, TextSnd.gui_snd_once);
            RFUI.Slider (sp_ini_mlt, multiplier_min, multiplier_max, TextSnd.gui_snd_mlt);
            RFUI.PropertyField (sp_ini_clip, TextSnd.gui_snd_clip);
            ...
            RFUI.PropertyField (sp_ini_group, TextSnd.gui_out_group);

            if (sound.initialization.outputGroup != null)
            {
                EditorGUI.indentLevel++;
                RFUI.IntSlider (sp_ini_prior, priority_min, priority_max, TextSnd.gui_out_prior);
                RFUI.Slider (sp_ini_spat,  spatial_min,  spatial_max,  TextSnd.gui_out_spat);
                RFUI.PropertyField (sp_ini_mind, TextSnd.gui_out_mind);
                RFUI.PropertyField (sp_ini_maxd, TextSnd.gui_out_maxd);
                EditorGUI.indentLevel--;
            }
        ...
        void GUI_PropsAct()
        {
            ...
            RFUI.PropertyField (sp_act_once, TextSnd.gui_snd_once);
            RFUI.Slider (sp_act_mlt, multiplier_min, multiplier_max, TextSnd.gui_snd_mlt);
            RFUI.PropertyField (sp_act_clip, TextSnd.gui_snd_clip);
            ...
            RFUI.PropertyField (sp_act_group, TextSnd.gui_out_group);

            if (sound.activation.outputGroup != null)
            {
                EditorGUI.indentLevel++;
                RFUI.IntSlider (sp_act_prior, priority_min, priority_max, TextSnd.gui_out_prior);
                RFUI.Slider (sp_act_spat,  spatial_min,  spatial_max,  TextSnd.gui_out_spat);
                RFUI.PropertyField (sp_act_mind, TextSnd.gui_out_mind);
                RFUI.PropertyField (sp_act_maxd, TextSnd.gui_out_maxd);
                EditorGUI.indentLevel--;
            }
        ...
        void GUI_PropsDml()
        {
            ...
            RFUI.PropertyField (sp_dml_once, TextSnd.gui_snd_once);
            RFUI.Slider (sp_dml_mlt, multiplier_min, multiplier_max, TextSnd.gui_snd_mlt);
            RFUI.PropertyField (sp_dml_clip, TextSnd.gui_snd_clip);
            ...
            RFUI.PropertyField (sp_dml_group, TextSnd.gui_out_group);

            if (sound.demolition.outputGroup != null)
            {
                EditorGUI.indentLevel++;
                RFUI.IntSlider (sp_dml_prior, priority_min, priority_max, TextSnd.gui_out_prior);
                RFUI.Slider (sp_dml_spat,  spatial_min,  spatial_max,  TextSnd.gui_out_spat);
                RFUI.PropertyField (sp_dml_mind, TextSnd.gui_out_mind);
                RFUI.PropertyField (sp_dml_maxd, TextSnd.gui_out_maxd);
                EditorGUI.indentLevel--;
            }
        ...
        void GUI_PropsCol()
        {
            ...
            RFUI.Caption (TextSnd.gui_cap_col);
            RFUI.Slider (sp_col_vel, multiplier_min, multiplier_max, TextSnd.gui_snd_vel);
            
            RFUI.Space ();
            GUILayout.Label (TextSnd.str_vel + sound.lastCollision);
            RFUI.Space ();
            
            RFUI.Caption (TextSnd.gui_cap_snd);
            
            RFUI.PropertyField (sp_col_once, TextSnd.gui_snd_once);
            RFUI.Slider (sp_col_mlt, multiplier_min, multiplier_max, TextSnd.gui_snd_mlt);
            RFUI.PropertyField (sp_col_clip, TextSnd.gui_snd_clip);
            ...
            RFUI.PropertyField (sp_col_group, TextSnd.gui_out_group);

            if (sound.collision.outputGroup != null)
            {
                EditorGUI.indentLevel++;
                RFUI.IntSlider (sp_col_prior, priority_min, priority_max, TextSnd.gui_out_prior);
                RFUI.Slider (sp_col_spat,  spatial_min,  spatial_max,  TextSnd.gui_out_spat);
                RFUI.PropertyField (sp_col_mind, TextSnd.gui_out_mind);
                RFUI.PropertyField (sp_col_maxd, TextSnd.gui_out_maxd);
                EditorGUI.indentLevel--;
            }
        ...
        void GUI_Filters()
        {
            RFUI.Caption (TextSnd.gui_cap_flt);
            RFUI.Slider (sp_flt_size, size_min,     size_max,     TextSnd.gui_flt_size);
            RFUI.Slider (sp_flt_dist, distance_min, distance_max, TextSnd.gui_flt_dist);
        }
