...
namespace RayFireEditor
{
    ...
    public class RayfireVortexEditor : Editor
    {
        ...
        void GUI_Anchor()
        {
            RFUI.CaptionBox (TextVrt.gui_cap_anc);
            RFUI.PropertyField (sp_anc_show, TextVrt.gui_anc_show);
            RFUI.PropertyField (sp_anc_top,  TextVrt.gui_anc_top);
            RFUI.PropertyField (sp_anc_bot,  TextVrt.gui_anc_bot);
        }
        
        void GUI_Gizmo()
        {
            RFUI.CaptionBox (TextVrt.gui_cap_giz);
            RFUI.PropertyField (sp_giz_show, TextVrt.gui_giz_show);
            RFUI.Slider (sp_giz_top, gizmo_top_min, gizmo_top_max, TextVrt.gui_giz_top);
            RFUI.Slider (sp_giz_bot, gizmo_bot_min, gizmo_bot_max, TextVrt.gui_giz_bot);
        }

        void GUI_Eye()
        {
            RFUI.CaptionBox (TextVrt.gui_cap_eye);
            RFUI.Slider (sp_eye, eye_min, eye_max, TextVrt.gui_eye);
        }

        void GUI_Strength()
        {
            RFUI.CaptionBox (TextVrt.gui_cap_str);
            RFUI.Slider (sp_stiff, stiff_min, stiff_max, TextVrt.gui_stiff);
            RFUI.Slider (sp_swirl, swirl_min, swirl_max, TextVrt.gui_swirl);
            RFUI.PropertyField (sp_strFrc, TextVrt.gui_strFrc);
        }

        void GUI_Torque()
        {
            RFUI.CaptionBox (TextVrt.gui_cap_tor);
            RFUI.PropertyField (sp_tor_en, TextVrt.gui_tor_en);
            if (vortex.enableTorque == true)
            {
                RFUI.Slider (sp_tor_str, torque_str_min, torque_str_max, TextVrt.gui_tor_str);
                RFUI.Slider (sp_tor_var, torque_var_min, torque_var_max, TextVrt.gui_tor_var);
            }
        }

        void GUI_Height()
        {
            RFUI.CaptionBox (TextVrt.gui_cap_hei);
            RFUI.PropertyField (sp_hei_en, TextVrt.gui_hei_en);
            if (vortex.enableHeightBias == true)
            {
                RFUI.Slider (sp_speed,  speed_min,  speed_max,  TextVrt.gui_speed);
                RFUI.Slider (sp_spread, spread_min, spread_max, TextVrt.gui_spread);
            }
        }

        void GUI_Seed()
        {
            RFUI.CaptionBox (TextVrt.gui_cap_seed);
            RFUI.IntSlider (sp_seed, seed_min, seed_max, TextVrt.gui_seed);
        }

        void GUI_Preview()
        {
            RFUI.CaptionBox (TextVrt.gui_cap_prev);
            RFUI.IntSlider (sp_circles, circles_min, circles_max, TextVrt.gui_circles);
        }
        
        void GUI_Filters()
        {
            RFUI.CaptionBox (TextVrt.gui_cap_flt);
            RFUI.TagField (sp_tag, TextWnd.gui_tag);
            RFUI.MaskField (sp_mask, TextVrt.gui_lay);
        }
