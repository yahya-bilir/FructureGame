...
namespace RayFireEditor
{
    ...
    public class RayfireSnapshotEditor : Editor
    {
        ...
        void GUI_Save()
        {
            RFUI.Caption (TextSnp.gui_cap_save);
            ...
            RFUI.PropertyField (sp_saveName, TextSnp.gui_saveName);
            RFUI.PropertyField (sp_saveComp, TextSnp.gui_saveComp);
        }

        void GUI_Load()
        {
            RFUI.Caption (TextSnp.gui_cap_load);
            RFUI.PropertyField (sp_loadSnap, TextSnp.gui_loadSnap);
            RFUI.Slider (sp_loadSize, size_min, size_max, TextSnp.gui_loadSize);
