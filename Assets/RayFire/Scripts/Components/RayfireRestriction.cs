...
namespace RayFire
{
    ...
    [AddComponentMenu (RFLog.rst_path)]
    [HelpURL (RFLog.rst_link)]
        ...
        public void InitRestriction (RayfireRigid scr)
        {
            ...
            if (distance > 0)
            {
                ...
                else
                {
                    if (target != null)
                        ...
                        RayfireMan.Log (RFLog.rst_dbgn + name + RFLog.rst_noTrg, gameObject);
                }
            }
            ...
            if (coll != null)
            {
                ...
                if (coll.isTrigger == false)
                    RayfireMan.Log (RFLog.rst_dbgn + name + RFLog.rst_noCol, gameObject);
