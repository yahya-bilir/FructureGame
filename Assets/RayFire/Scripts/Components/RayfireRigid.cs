...
namespace RayFire
{
    ...
    public class RayfireRigid : MonoBehaviour
    {
        ...
        // UI
        [FormerlySerializedAs ("initialization")] public      InitType              init      = InitType.ByMethod;
        ...
        [FormerlySerializedAs ("activation")]          public RFActivation          act       = new RFActivation();
        [FormerlySerializedAs ("limitations")]         public RFLimitations         lim       = new RFLimitations();
        ...
        void SetSkinnedMesh()
        {
            ...
            {
                if (mshDemol.engTp == RayfireShatter.RFEngineType.V1)
                    if (skr == null)
                        return;
        ...
        {
            if (mshDemol.engTp == RayfireShatter.RFEngineType.V2)
                return;
        ...
        public void Demolish()
        {
            ...
            if (RFDemolitionMesh.DemolishMesh (this, mshDemol.engTp) == true)
            {
        ...
        public void Slice()
        {
            ...
            if (IsMesh == true)
            {
                ...
                if (RFDemolitionMesh.SliceMesh (this, mshDemol.engTp) == false)
                    return;
        ...
        public void CacheFramesV1()
        {
            StartCoroutine (mshDemol.ch.RuntimeCachingCor(this));
        }
        
        // Caching into meshes over several frames
        public void CacheFramesV2()
        {
            StartCoroutine (mshDemol.ch.RuntimeCachingCor(this));
        }
