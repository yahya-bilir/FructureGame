...
namespace RayFire
{
    ...
    public class RFActivation
    {
        ...
        public static void ActivateRigid (RayfireRigid scr, bool connCheck = true)
        {
            ...
            if (scr.act.atb == false && scr.act.uny == true)
                return;
            ...
            // Connectivity check
            if (connCheck == true)
                scr.act.CheckConnectivity();
            
            // Set layer
            SetActivationLayer (scr);
            
            // Set state
            scr.act.activated = true;
            ...
            // Activation sound
            RFSound.ActivationSound (scr.sound, scr.lim.bboxSize);
        ...
        public static bool ActivateShard (RFShard shard, RayfireRigidRoot rigidRoot)
        {
            ...
            if (shard.rigid != null)
            {
                ...
                {
                    if (shard.rigid.act.activated == false)
                    {
                        ActivateRigid (shard.rigid);
                        return true;
                    }
        ...
        {
            if (scr.act.l == true)
                scr.gameObject.layer = scr.act.lay;
        }
        ...
        {
            if (scr.act.l == true)
                scr.gameObject.layer = scr.act.lb;
        }
        ...
        {
            if (scr.act.l == true)
                scr.act.lb = scr.gameObject.layer;
        }
